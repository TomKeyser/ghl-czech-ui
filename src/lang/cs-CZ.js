...
(function (root) {
  ...
  var pack = {
    ...
    patterns: {
      ...
      TIME_RANGE:     '{*1}–{*2}',
      /* the marketplace's developer line; the name stays raw. MY CZECH, pass 3. */
      BY_DEVELOPER:   'Od {1}',
  ...
  pack.dict = {
    ...
    /* THE SUB-MENU SWEEP, 11 Sep: ~90 pages read off each module's own top
       bar. Operator screens only. HighLevel's sales pages (AI Agents welcome,
       Voice AI welcome, WordPress hosting pitch) are parked, as in
       COVERAGE.md. MY CZECH throughout. */
    /* opportunities > forecast */
    "Max potential revenue":            "Maximální možné tržby",
    "Expected revenue":                 "Očekávané tržby",
    "Total value if all open opportunities close": "Celková hodnota, pokud se uzavřou všechny otevřené příležitosti",
    "Based on opportunity or stage probability": "Podle pravděpodobnosti příležitosti nebo fáze",
    "Total value of won opportunities": "Celková hodnota vyhraných příležitostí",
    "Opportunities currently in progress": "Příležitosti, které právě probíhají",
    "Missing close date":               "Chybí datum uzavření",
    "Not included in forecast calculations.": "Nezapočítává se do výpočtu prognózy.",
    "Missing opportunity value":        "Chybí hodnota příležitosti",
    /* HighLevel hard-codes "$0" even on a CZK account; "nulou" avoids a currency */
    "These opportunities contribute $0 to totals.": "Tyto příležitosti přispívají k součtům nulou.",
    "Overdue opportunities":            "Příležitosti po termínu",
    "May inflate forecast totals.":     "Mohou nadsazovat součty prognózy.",
    "Forecast views":                   "Zobrazení prognózy",
    "Forecast timeline":                "Časová osa prognózy",
    "At-risk opportunities":            "Ohrožené příležitosti",
    "Adjust risk settings":             "Upravit nastavení rizika",
    "Opportunities whose expected close date was pushed this period.":
      "Příležitosti, jejichž očekávané datum uzavření se v tomto období posunulo.",
    "Fix your forecast data":           "Opravte data prognózy",
    "Data quality directly impacts forecast accuracy.": "Kvalita dat přímo ovlivňuje přesnost prognózy.",
    "Group by":                         "Seskupit podle",
    "Opportunities by status":          "Příležitosti podle stavu",
    "Total potential":                  "Celkový potenciál",
    "High risk":                        "Vysoké riziko",
    "Medium risk":                      "Střední riziko",
    "Low risk":                         "Nízké riziko",
    "Slipped 2+ times or 14+ days":     "Odloženo alespoň 2× nebo o 14 a více dní",
    "Slipped 1+ times or 7+ days (excluding high)": "Odloženo alespoň 1× nebo o 7 a více dní (kromě vysokého)",
    "Slipped 1+ times or 1+ days (excluding high/medium)": "Odloženo alespoň 1× nebo alespoň o 1 den (kromě vysokého a středního)",
    "Let AI draft your replies":        "Nechte AI navrhnout odpovědi",
    /* conversations > manual actions, SLA settings, SLA analytics */
    "Good Work!":                       "Dobrá práce!",
    "You have no pending tasks":        "Nemáte žádné čekající úkoly",
    "Let's Start":                      "Začněme",
    "Select Campaign":                  "Vyberte kampaň",
    "Select Type":                      "Vyberte typ",
    "Select Workflow":                  "Vyberte workflow",
    "Manual Actions are tasks that require you to manually place calls or send SMS messages to contacts.":
      "Ruční akce jsou úkoly, při kterých kontaktům ručně voláte nebo posíláte SMS.",
    "SLA Settings":                     "Nastavení SLA",
    "Set SLA":                          "Nastavit SLA",
    "Define how quickly your team should respond to customer messages":
      "Určete, jak rychle má váš tým odpovídat na zprávy zákazníků",
    "No SLA are set":                   "Není nastavena žádná SLA",
    "SLAs help you define response time targets so your team never leaves a contact waiting.":
      "SLA stanoví cílové doby odezvy, aby váš tým nenechával žádný kontakt čekat.",
    "Turn on SLA settings":             "Zapnout nastavení SLA",
    "SLA performance":                  "Plnění SLA",
    "SLA overview":                     "Přehled SLA",
    "Monitor response times and evaluate how consistently SLAs are met or breached.":
      "Sledujte doby odezvy a vyhodnocujte, jak spolehlivě se SLA dodržují nebo porušují.",
    "It feels a bit empty here!":       "Zatím je tu trochu prázdno!",
    "Turn on SLA settings to start tracking response times and measure your team's performance.":
      "Zapněte nastavení SLA a začněte sledovat doby odezvy a výkon svého týmu.",
    /* companies, contact detail */
    "No Companies yet":                 "Zatím žádné firmy",
    "Add a new Company, or import existing ones from a CSV file.":
      "Přidejte novou firmu nebo importujte stávající ze souboru CSV.",
    "common.resize":                    "Změnit velikost",
    /* sites > analytics */
    "Average time":                     "Průměrná doba",
    "Page views":                       "Zobrazení stránek",
    "Understand more about stats":      "Více o statistikách",
    "Effortlessly track and analyze key metrics with our sites analytics tool":
      "Sledujte a analyzujte klíčové metriky svých webů",
    "Advanced filter":                  "Rozšířený filtr",
    "Opt-ins":                          "Přihlášení",
    "Opt-in conversion rate":           "Konverzní poměr přihlášení",
    "Exit before 30s":                  "Odchod do 30 s",
    "Top client IPs":                   "Nejčastější IP adresy",
    "Client IPs":                       "IP adresy",
    "Top browsers":                     "Nejčastější prohlížeče",
    "Browsers":                         "Prohlížeče",
    "Traffic by device type":           "Návštěvnost podle typu zařízení",
    "Top visits by":                    "Nejvíce návštěv podle",
    "Countries":                        "Země",
    "Total number of visitors:":        "Celkový počet návštěvníků:",
    "Acquisition data":                 "Zdroje návštěvnosti",
    "Traffic channel":                  "Kanál návštěvnosti",
    "Source/Medium":                    "Zdroj/médium",
    "Video engagement overview":        "Přehled zapojení u videí",
    "Drop-off spike":                   "Nárůst odchodů",
    "Video play":                       "Přehrání videa",
    "Video pauses":                     "Pozastavení videa",
    "Completion":                       "Dokončení",
    "Video engagement":                 "Zapojení u videí",
    "Page views by funnels":            "Zobrazení stránek podle funnelů",
    /* reputation, blogs, forms, chat widget, QR codes */
    "Generating AI summary...":         "Generuje se shrnutí AI…",
    "Regenerating AI summary...":       "Znovu se generuje shrnutí AI…",
    "Manage and oversee all blogs created by you for your business.":
      "Spravujte všechny blogy, které jste pro svou firmu vytvořili.",
    "Create blog":                      "Vytvořit blog",
    "Total blog posts":                 "Celkem příspěvků",
    "Published blog sites":             "Publikované blogy",
    "Visitors per week":                "Návštěvníci za týden",
    "Blog site":                        "Blog",
    "No blog sites found":              "Žádné blogy nenalezeny",
    "Get started by creating a new blog site.": "Začněte vytvořením nového blogu.",
    "New blog site":                    "Nový blog",
    "Search for forms":                 "Hledat formuláře",
    "Updated by":                       "Aktualizoval(a)",
    "All forms":                        "Všechny formuláře",
    "Chat Widgets":                     "Chatovací widgety",
    "Library":                          "Knihovna",
    "Search QR codes":                  "Hledat QR kódy",
    /* quiz builder's how-it-works slide */
    "1 · Set category & score":         "1 · Nastavte kategorii a skóre",
    "2 · Add score tiers":              "2 · Přidejte úrovně skóre",
    "3 · The lead answers":             "3 · Zájemce odpovídá",
    "4 · Their result":                 "4 · Jeho výsledek",
    /* memberships: courses dashboard, course progress, domain, certificates */
    "No Performance Data Yet":          "Zatím žádná data o výkonu",
    "Start enrolling learners to atleast two of your courses to see this comparison":
      "Zapište studenty alespoň do dvou kurzů, abyste viděli toto srovnání",
    "Go to Revenue":                    "Přejít na tržby",
    "Welcome!":                         "Vítejte!",
    "You are viewing sample data. Launch your first course to begin tracking actual data":
      "Prohlížíte si ukázková data. Spusťte svůj první kurz a začněte sledovat skutečná data",
    "Bring Your Ideas to Life. Start Creating Your First Course Today!":
      "Proměňte své nápady ve skutečnost. Vytvořte svůj první kurz ještě dnes!",
    "Total Checkouts":                  "Celkem objednávek",
    "Upsell Conversions":               "Konverze navazujících nabídek",
    "Average Order Value":              "Průměrná hodnota objednávky",
    "AOV per User":                     "Průměrná objednávka na uživatele",
    "Highest Order Value":              "Nejvyšší hodnota objednávky",
    "Course Progress Funnel":           "Trychtýř postupu v kurzu",
    "Go to Funnel":                     "Přejít na trychtýř",
    "Quick Help":                       "Rychlá nápověda",
    "Getting Started - Launch a Course": "Začínáme – spuštění kurzu",
    "Learn how to create engaging courses": "Naučte se vytvářet poutavé kurzy",
    "New Theme Customizer for Courses": "Nový editor vzhledu kurzů",
    "Customize your course appearance and themes": "Přizpůsobte vzhled a motivy kurzů",
    "Magic Links In Memberships(Courses)": "Magické odkazy v členství (kurzy)",
    "Learn how to use magic links for easy access": "Naučte se používat magické odkazy pro snadný přístup",
    "Magic Links":                      "Magické odkazy",
    "Open column filter":               "Otevřít filtr sloupce",
    "Refresh course progress":          "Obnovit postup v kurzu",
    "Collapse user conversion funnel":  "Sbalit konverzní trychtýř uživatelů",
    "Course progress summary":          "Souhrn postupu v kurzu",
    "Sample data notice":               "Upozornění na ukázková data",
    "Filter course progress members by not started learning":
      "Filtrovat členy, kteří se ještě nezačali učit",
    "Filter course progress members by haven't completed course":
      "Filtrovat členy, kteří nedokončili kurz",
    "startDate":                        "Datum zahájení",
    "lastAccessed":                     "Poslední přístup",
    "enrolmentDate":                    "Datum zápisu",
    "sessionCount":                     "Počet relací",
    "coursesCompleted":                 "Dokončené kurzy",
    "Back to settings":                 "Zpět do nastavení",
    "Sub Domain":                       "Subdoména",
    "Enter custom domain":              "Zadejte vlastní doménu",
    "Setup Domain":                     "Nastavit doménu",
    "Update Domain":                    "Aktualizovat doménu",
    "Set up the Sub-Domain for client portal or use a custom domain":
      "Nastavte subdoménu klientského portálu nebo použijte vlastní doménu",
    "Customize your client portal sub domain": "Přizpůsobte subdoménu klientského portálu",
    "Custom Domain":                    "Vlastní doména",
    "Use your custom domain for Client Portal": "Použijte pro klientský portál vlastní doménu",
    "Time to award your member!":       "Je čas ocenit vašeho člena!",
    "No templates in here! Ready to create a fresh certificate?":
      "Zatím tu nejsou žádné šablony. Chcete vytvořit nový certifikát?",
    "Loading branded app settings":     "Načítá se nastavení značkové aplikace",
    /* AI agents: agent studio, conversation AI, knowledge base, content AI, logs */
    "Managed Agents":                   "Spravovaní agenti",
    "Build and manage AI agents for your business": "Vytvářejte a spravujte AI agenty pro svou firmu",
    "Create Managed Agent":             "Vytvořit spravovaného agenta",
    "Agent Studio is Evolving":         "Agent Studio se mění",
    "Know more":                        "Více informací",
    "No agents in this folder yet":     "V této složce zatím nejsou žádní agenti",
    "Get started by creating a new agent in this folder.": "Začněte vytvořením nového agenta v této složce.",
    "No Managed Agents yet":            "Zatím žádní spravovaní agenti",
    "Create your first Managed Agent to get started.": "Začněte vytvořením prvního spravovaného agenta.",
    "Create Bot":                       "Vytvořit bota",
    "Search Agent":                     "Hledat agenta",
    "Conversation AI Agents":           "Agenti Conversation AI",
    "Create And Manage Multiple Agents For Your Business": "Vytvářejte a spravujte více agentů pro svou firmu",
    "Manage Knowledge Base":            "Spravovat znalostní bázi",
    "Agents List":                      "Seznam agentů",
    "Welcome to Conversation AI!":      "Vítejte v Conversation AI!",
    "Let your Bot take care of the mundane tasks, while you focus on building your Business!":
      "Nechte bota vyřizovat rutinní úkoly a věnujte se budování své firmy!",
    "Loading usage":                    "Načítá se využití",
    "Knowledge Base announcements":     "Novinky znalostní báze",
    "Announcements pagination":         "Stránkování novinek",
    "Search knowledge base":            "Hledat ve znalostní bázi",
    "kbGaps":                           "Mezery ve znalostní bázi",
    "KB gaps":                          "Mezery ve znalostní bázi",
    "Create and manage multiple knowledge bases for your business":
      "Vytvářejte a spravujte více znalostních bází pro svou firmu",
    "Create knowledge base":            "Vytvořit znalostní bázi",
    "AI Search across your Knowledge Base": "AI vyhledávání ve znalostní bázi",
    "Ask a question and get the answer pulled from every article — no folder hunting.":
      "Položte otázku a odpověď se najde ve všech článcích – bez prohledávání složek.",
    "Knowledge base quota":             "Kvóta znalostní báze",
    "Manage your AI generated content": "Spravujte obsah vytvořený AI",
    "Total words generated":            "Celkem vygenerovaných slov",
    "Words/day":                        "Slov za den",
    "Variation Count":                  "Počet variant",
    "Transaction ID":                   "ID transakce",
    "Total Words Count":                "Celkový počet slov",
    "Search logs":                      "Hledat v protokolech",
    "View and manage agent activity logs.": "Prohlížejte a spravujte protokoly aktivity agentů.",
    "AI Product":                       "AI produkt",
    "Duration / Latency":               "Trvání / latence",
    "Agent ID":                         "ID agenta",
    "Messages":                         "Zprávy",
    "Conversation ID":                  "ID konverzace",
    "Tokens":                           "Tokeny",
    "Sessions":                         "Relace",
    "Metrics":                          "Metriky",
    "No logs yet":                      "Zatím žádné protokoly",
    "Agent logs will appear here when activity occurs.": "Protokoly agentů se tu zobrazí, jakmile dojde k nějaké aktivitě.",
    /* the agent-templates marketplace's own interface (cards are firewalled) */
    "Search for agents...":             "Hledat agenty…",
    "Bot filters navigation":           "Navigace filtrů botů",
    "Use Cases":                        "Použití",
